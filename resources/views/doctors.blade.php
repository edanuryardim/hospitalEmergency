                ...
                <div class="card">
                    <div class="body text-center">
                        ...
                        <div class="exit-edit-buttons">
                            ...
                            <form method="POST" action="{{ route('exitDoctor')}}" id="exitForm_{{ $doctor->id }}">
                                @csrf
                                <button type="button" class="btn btn-danger exit-btn d-flex align-items-center" style="width:37px; height:30px;" data-toggle="tooltip" data-placement="top" title="Exit" onclick="confirmExit('{{ $doctor->id }}')">
                            ...
                            <a href="{{ route('doctorEditIndex', ['id' => $doctor->id]) }}" class="btn btn-primary edit-btn" data-toggle="tooltip" data-placement="top" title="Edit" style="display: flex; justify-content: flex-end; width:37px;height:30px;">
                        ...
                        <div class="chart easy-pie-chart-1" data-percent="75">
                            <span><img src="{{asset($doctor->image)}}" data-toggle="tooltip" data-placement="top" title="" alt="user" class="rounded-circle" data-original-title="Dr. Avatar"></span>
...
<script>
    function confirmExit(doctorId) {
        var confirmation = confirm("Do you want to terminate the doctor?");

        if (confirmation) {
            // Eğer kullanıcı onaylarsa, formu submit et
            document.getElementById("exitForm_" + doctorId).submit();
        }
    }
</script>
